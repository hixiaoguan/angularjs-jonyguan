...
require_once(XGINC.'/charset.class.php');
...

{
...

	{
		...
		require_once(XGINC."/inc_fun_funString.php");
...

{
...

	{
		...
		require_once(XGINC."/inc_fun_funAdmin.php");
...

{
	...
	include_once(XGINC."/inc_stat.php");
...

{
...

	{
      ...
      function JumpUrl(){
		...
		$rmsg .= "<div style='padding:6px;font-size:12px;border-bottom:1px solid #D1DDAA;background:#DBEEBD url({$GLOBALS['cfg_phpurl']}/img/wbg.gif)';'><b>Message!</b></div>\");\r\n";
...

{
	...
	include_once(XGINC."/channelunit.func.php");
...
// 	if($watermark) include_once(XGINC.'/image.func.php');
...
// 	chmod($cfg_basedir.$fileurl,0644);
...
// if( file_exists(XGINC.'/extend.func.php') ) {

// 	require_once(XGINC.'/extend.func.php');
