...

{
	...
	function XgSql($pconnect=false,$nconnect=true)
...

	{
		...
		$errorTrackFile = XGINC.'/../date/mysql_error_trace.inc';
...

{
	...
	$log_file = XGINC.'/../date/log/'.md5($cfg_cookie_encode).'_safe.txt';
